...
const state = { s: built.receipts[0].ds.slice(0, 10), e: built.receipts[built.receipts.length - 1].ds.slice(0, 10),
  days: [true, true, true, true, true, true, true], bigOn: false, threshold: 200 };
...
function tot(s, e, days, bigOn, threshold) {
  const st = { s, e, days: days || [true, true, true, true, true, true, true], bigOn: !!bigOn, threshold: threshold || 200 };
...
t('August minus >=200 $2,759.56 / 63', (() => { const x = tot('2026-08-01', '2026-08-31', null, true); return Math.abs(x.tot - 2759.56) < 0.01 && x.n === 63; })());
